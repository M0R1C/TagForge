...
* **Batch editing:** Edit captions for multiple files at once - delete, add, or replace tags. Create backups, rename all your files, and assign sequential numbers to keep everything tidy. AI models for auto-generate captions. Quickly crop the parts you need using YOLO detectors. Automatically spot AI-generated artifacts on images. You can easily add your own ONNX models - just place them in the `models` folder. Models from **Smiling Wolf** are recommended
